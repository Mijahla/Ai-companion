...
//interface so that we know that the categories is a prisma model category and an array
...
export const CompanionForm = ({
    ...
    const onSubmit = async (values:z.infer<typeof formSchema>) => {
        try {
            ...
            router.refresh(); //refreshes all the server components to load the new ones
            router.push("/");
        } catch(error) {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <FormField name="description" control={form.control} render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormControl>
                                    <Input disabled={isLoading} placeholder="CEO and founder of tesla and spacex" {...field} /> 
                                </FormControl>
                                <FormDescription>
